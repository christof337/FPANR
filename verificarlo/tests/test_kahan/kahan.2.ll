...
; <label>:21:                                     ; preds = %21, %20
  ...
  %33 = call <4 x float> @_4xfloatadd(<4 x float> %29, <4 x float> %23)
  %34 = call <4 x float> @_4xfloatadd(<4 x float> %32, <4 x float> %24)
  %35 = add i64 %22, 8
  %36 = add i64 %25, -1
  %37 = icmp eq i64 %36, 0
...
; <label>:47:                                     ; preds = %47, %46
  ...
  %58 = call <4 x float> @_4xfloatadd(<4 x float> %54, <4 x float> %49)
  %59 = call <4 x float> @_4xfloatadd(<4 x float> %57, <4 x float> %50)
  %60 = add i64 %48, 8
  %61 = or i64 %60, 1
  ...
  %68 = call <4 x float> @_4xfloatadd(<4 x float> %64, <4 x float> %58)
  %69 = call <4 x float> @_4xfloatadd(<4 x float> %67, <4 x float> %59)
  %70 = add i64 %48, 16
  %71 = or i64 %70, 1
  ...
  %78 = call <4 x float> @_4xfloatadd(<4 x float> %74, <4 x float> %68)
  %79 = call <4 x float> @_4xfloatadd(<4 x float> %77, <4 x float> %69)
  %80 = add i64 %48, 24
  %81 = or i64 %80, 1
  ...
  %88 = call <4 x float> @_4xfloatadd(<4 x float> %84, <4 x float> %78)
  %89 = call <4 x float> @_4xfloatadd(<4 x float> %87, <4 x float> %79)
  %90 = add i64 %48, 32
...
; <label>:116:                                    ; preds = %115, %93, %2
  %117 = phi float [ %3, %2 ], [ %101, %93 ], [ %112, %115 ]
  ret float %117
}
...
declare <4 x float> @_4xfloatadd(<4 x float>, <4 x float>)
