...
define double @g(double) #0 {
  ...
  store double %0, double* %2, align 8
  %3 = load double, double* %2, align 8
  %4 = fsub double %3, 0x3FF1C71C71C72C15
  ret double %4
}
...
define i32 @main() #0 {
  ...
  store double 0x3FF1C71C71C71A7D, double* %1, align 8
  %4 = load double, double* %1, align 8
  %5 = call double @f(double %4)
  ...
  %9 = call double @g(double %8)
  store double %9, double* %3, align 8
  %10 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %11 = load double, double* %3, align 8
  %12 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %10, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), double %11)
  ret i32 0
}
